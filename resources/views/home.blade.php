                ...
                <div class="col-lg-6 col-md-10">
                    <div class="about-caption mb-50">
                        ...
                        <div class="about-btn1 mb-30">
                            <a href="{{ route('reg')}}" class="btn btn-primary btn-lg about-btn">Register now <i class="ti-arrow-right"></i></a>
                        </div>
                        <div class="about-btn1 mb-30">
                            <a href="{{ route('logindisplay')}}" class="btn btn-primary btn-lg about-btn">Login<i class="ti-arrow-right"></i></a>
                        </div>
                        {{-- <div class="about-btn1 mb-30">
                        ...
                        <div class="row align-items-center no-gutters">
                            ...
                            <div class="col-lg-5">
                                <div class="dept_thumb">
                                    <img src="user/assets/img/gallery/department_man.png" alt="">
                                </div>
                            </div>
                        </div>
                        <!-- single_content  -->
            ...
            <div class="row">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="single-gallery mb-30">
                                <div class="gallery-img big-img" style="background-image: url(user/assets/img/gallery/gallery1.png);"></div>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            <div class="single-gallery mb-30">
                                <div class="gallery-img small-img" style="background-image: url(user/assets/img/gallery/gallery2.png);"></div>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            <div class="single-gallery mb-30">
                                <div class="gallery-img small-img" style="background-image: url(user/assets/img/gallery/gallery3.png);"></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-6">
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            <div class="single-gallery mb-30">
                                <div class="gallery-img small-img" style="background-image: url(user/assets/img/gallery/gallery4.png);"></div>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            <div class="single-gallery mb-30">
                                <div class="gallery-img small-img" style="background-image: url(user/assets/img/gallery/gallery5.png);"></div>
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <div class="single-gallery mb-30">
                                <div class="gallery-img big-img" style="background-image: url(user/assets/img/gallery/gallery6.png);"></div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="testimonial-caption ">
                        ...
                        <div class="testimonial-founder d-flex align-items-center justify-content-center">
                            <div class="founder-img">
                                <img src="user/assets/img/gallery/Homepage_testi.png" alt="">
                            </div>
            ...
            <div class="row">
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-">
                    <div class="single-team mb-30">
                        <div class="team-img">
                            <img src="user/assets/img/gallery/team2.png" alt="">
                        </div>
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-">
                    <div class="single-team mb-30">
                        <div class="team-img">
                            <img src="user/assets/img/gallery/team3.png" alt="">
                        </div>
                        <div class="team-caption">
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-">
                    <div class="single-team mb-30">
                        <div class="team-img">
                            <img src="user/assets/img/gallery/team1.png" alt="">
                        </div>
                        <div class="team-caption">
    ...
    <!-- Team End -->
     ...
     <div class="contact-form-main">
        ...
        <div class="from-left d-none d-lg-block">
            <img src="user/assets/img/gallery/contact_form.png" alt="">
        </div>
    </div>
    <!-- Contact form End -->
